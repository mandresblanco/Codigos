...
def ejecutar_buscar_cancion(canciones:list)->None:
    ...
    cancion_encontrada = bb.buscar_cancion(cancion,anio,canciones)
    if cancion_encontrada == None:
        print("No se encontro la canción ingresada, por favor valide el nombre o el año del ranking ingresado")
    else:
        print("Se encontro la canción, y tiene la siguiente información: ")
...
def ejecutar_canciones_anio(canciones:list)->None:
    ...
    #TODO: complete el código haciendo el llamado a la función del módulo que
    #implementa este requrimiento e imprimiendo por pantalla el resultado
    cancion_anio = bb.canciones_anio(anio,canciones)
    if cancion_anio == None:
        print("No se encontro el año ingresado, por favor valide el año del ranking ingresado")
    else:
        print("Se encontro las siguientes canciones para ese año: ")
        print(cancion_anio)
    return cancion_anio
...
def ejecutar_canciones_artista_periodo(canciones:list)->None:
    ...
    #TODO: complete el código haciendo el llamado a la función del módulo que
    #implementa este requrimiento e imprimiendo por pantalla el resultado
    cancion_artistas = bb.canciones_artista(artista, anio_inic, anio_fin, canciones)
    if cancion_artistas == None:
        print("No se encontro el artista ingresado, por favor valide el artista")
    else:
        print("Se encontro las siguientes canciones para ese artista: ")
        print(cancion_artistas)
...
def ejecutar_todas_canciones_artista(canciones:list)->None:
    ...
    accion = bb.buscar_por_artista(canciones, artista)
    print(accion)
...
def ejecutar_todos_artistas_cancion(canciones:list)->None:
    ...
    accion = bb.buscar_interpretes(canciones, cancion)
    print(accion)

def ejecutar_artistas_mas_populares(canciones:list)->None:
    """ Ejecuta la opción de consultar los artistas más populares 
    """
    minimas = int(input("Por favor ingrese la cantidad mínima de canciones que desea buscar: "))

    accion = bb.canciones_minimas(canciones, minimas)
    print(accion)
...
def ejecutar_artistas_y_sus_canciones(canciones:list)->None:
    ...
    accion = bb.buscar_lista_artistas(canciones)
    print(accion)
